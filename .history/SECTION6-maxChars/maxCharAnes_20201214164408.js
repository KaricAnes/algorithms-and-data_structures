...
//Does the given string have any repeated characters in it? trazimo duplikate
...
const maxChar = (str) => {
  ...
  let max = Object.keys(counts).reduce(function (a, b) {
    //ovdje nam je trebao key koji ima najveci value od svih u counts objektu
    //pretvorili smo counts iz obj u array, i preko reduce-a uzeli key koji ima najveci value
    //a je 1, a b je 5 ---> keys
